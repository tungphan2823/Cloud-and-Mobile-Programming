...
public class Meeting implements Serializable {
    ...
    public Meeting(String title, String place, List<String> participants, String date, String time,  List<String> imagePaths) {
        this.title = title;
        this.place = place;
    ...
    public String toString() {
        return "Meeting{" +
                ...
                ", date='" + date + '\'' +
                ", time='" + time + '\'' +
                ", imagePaths=" + imagePaths + // Updated to show list of image paths
                '}';
    }
